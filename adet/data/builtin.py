...
from .datasets.map import register_map_text_instances # for map data
...
_PREDEFINED_SPLITS_MAP_TEXT = {
    
    "maps_train": ("maps/train", "maps/map-anno/train"),
    # evaluation
    "maps_val": ("maps/val", "maps/map-anno/val")
}
...
#  #########################################################################################       
    # register map dataset
    for key, (image_root, json_file) in _PREDEFINED_SPLITS_MAP_TEXT.items():
        
        #print(key, image_root, json_file)
        #voc_size_cfg = 96
        register_map_text_instances(
            key, 
            metadata_text,
